...
public class OrderAdd extends JFrame {
	...
	private String[] itemImagePaths = {
			"/controller/images/aChoy.jpg", "/controller/images/carrot.jpg", "/controller/images/chineseCelery.jpg",
	        "/controller/images/daikonRadish.jpg", "/controller/images/onion.jpg", "/controller/images/spoonCabbage.jpg",
	        "/controller/images/sugarSnapPea.jpg", "/controller/images/waterSpinach.jpg", "/controller/images/welshOnion.jpg" 
	    };
	...
	public OrderAdd() {
		...
		img_Item1.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[0])));
		img_Item1.setBounds(54, 29, 128, 128);
		panel_1.add(img_Item1);
		
		JLabel img_Item2 = new JLabel("");
		img_Item2.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[1])));
		img_Item2.setBounds(253, 29, 128, 128);
		panel_1.add(img_Item2);
		
		JLabel img_Item3 = new JLabel("");
		img_Item3.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[2])));
		img_Item3.setBounds(54, 259, 128, 128);
		panel_1.add(img_Item3);
		
		JLabel img_Item4 = new JLabel("");
		img_Item4.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[3])));
		img_Item4.setBounds(253, 259, 128, 128);
		panel_1.add(img_Item4);
		
		JLabel img_Item5 = new JLabel("");
		img_Item5.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[4])));
		img_Item5.setBounds(54, 489, 128, 128);
		panel_1.add(img_Item5);
		
		JLabel img_Item6 = new JLabel("");
		img_Item6.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[5])));
		img_Item6.setBounds(253, 489, 128, 128);
		panel_1.add(img_Item6);
		
		JLabel img_Item7 = new JLabel("");
		img_Item7.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[6])));
		img_Item7.setBounds(54, 719, 128, 128);
		panel_1.add(img_Item7);
		
		JLabel img_Item8 = new JLabel("");
		img_Item8.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[7])));
		img_Item8.setBounds(253, 719, 128, 128);
		panel_1.add(img_Item8);
		
		JLabel img_Item9 = new JLabel("");
		img_Item9.setIcon(new ImageIcon(OrderAdd.class.getResource(itemImagePaths[8])));
